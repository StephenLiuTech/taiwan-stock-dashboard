...
SECURITIES: dict[str, tuple[str, Market]] = {
    ...
    "元大台灣50正2": ("00631L", Market.TWSE),
    "國泰臺韓科技": ("00735", Market.TWSE),
    "國泰費城半導體": ("00830", Market.TWSE),
    "永豐中國科技50大": ("00887", Market.TWSE),
    "群益台灣精選高息": ("00919", Market.TWSE),
    "主動統一台股增長": ("00981A", Market.TWSE),
    "長興": ("1717", Market.TWSE),
    "富喬": ("1815", Market.TPEX),
    "大成鋼": ("2027", Market.TWSE),
    "台達電": ("2308", Market.TWSE),
    "華通": ("2313", Market.TWSE),
    "台積電": ("2330", Market.TWSE),
    "華邦電": ("2344", Market.TWSE),
    "南亞科": ("2408", Market.TWSE),
    "聯發科": ("2454", Market.TWSE),
    "盟立": ("2464", Market.TWSE),
    "鈊象": ("3293", Market.TPEX),
    "材料*-KY": ("4763", Market.TWSE),
